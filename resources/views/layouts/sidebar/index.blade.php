...
<div class="leftside-menu">
  ...
  <a href="index.html" class="logo logo-dark">
    <span class="logo-lg">
      <img src="assets/hyper5/images/logo-dark.png" alt="dark logo" height="22" />
    </span>
    <span class="logo-sm">
      <img src="assets/hyper5/images/logo-dark-sm.png" alt="small logo" height="22" />
    </span>
  </a>
  ...
  <div class="h-100" id="leftside-menu-container" data-simplebar>
    ...
    <div class="leftbar-user">
      <a href="pages-profile.html">
        <img src="assets/hyper5/images/users/avatar-1.jpg" alt="user-image" height="42"
      ...
      <li class="side-nav-item">
        ...
        <div class="collapse" id="sidebarCrm">
          <ul class="side-nav-second-level">
            ...
            <li>
              <a href="crm-orders-list.html">Role</a>
            </li>
            <li>
              <a href="crm-clients.html">Permission</a>
            </li>
          </ul>
        </div>
      </li>
          ...
          <ul class="side-nav-second-level">
            ...
            <li>
              <a href="apps-projects-gantt.html">Gantt
                <span class="badge rounded-pill bg-light text-dark font-10 float-end">New</span></a>
            </li>
            <li>
    ...
    {{-- <div class="help-box text-white text-center">
      ...
      <img src="assets/hyper5/images/svg/help-icon.svg" height="90" alt="Helper Icon Image" />
